...
class Ui_ThresholdDialog(object):
    def setupUi(self, ThresholdDialog):
        ...
        ThresholdDialog.resize(359, 458)
        ...
        self.pushBtn_saveSettingsRecord.setGeometry(QtCore.QRect(14, 394, 150, 40))
        font = QtGui.QFont()
        font.setFamily("幼圆")
        ...
        self.pushBtn_readSettingsRecord.setGeometry(QtCore.QRect(196, 394, 150, 40))
        font = QtGui.QFont()
        font.setFamily("幼圆")
        font.setPointSize(18)
        font.setBold(False)
        ...
        self.line.setGeometry(QtCore.QRect(0, 382, 345, 16))
