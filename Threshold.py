...
class ThresholdWin(QDialog, Ui_ThresholdDialog):
    ...
    def __init__(self):
        ...
        self.getUserPara()
        # 漏电流
        self.dcUpVdt = VLDR_INTFOLAT(150, 80)
        self.lineEdit_setDrainCurrentTop.setValidator(self.dcUpVdt)
        self.lineEdit_setDrainCurrentTop.setToolTip('[150, 80]')
        self.dcDnVdt = VLDR_INTFOLAT(10, 0)
        self.lineEdit_setDrainCurrentBottom.setValidator(self.dcDnVdt)
        self.lineEdit_setDrainCurrentBottom.setToolTip('[10, 0]')
        # 工作电流
        self.wcUpVdt = VLDR_INTFOLAT(3000, 1000)
        self.lineEdit_setWorkCurrentTop.setValidator(self.wcUpVdt)
        self.lineEdit_setWorkCurrentTop.setToolTip('[3000, 1000]')
        self.wcDnVdt = VLDR_INTFOLAT(100, 0)
        self.lineEdit_setWorkCurrentBottom.setValidator(self.wcDnVdt)
        self.lineEdit_setWorkCurrentBottom.setToolTip('[100, 0]')
        # 起爆电压
        self.fvUpVdt = VLDR_INTFOLAT(74, 72)
        self.lineEdit_setFireVoltageTop.setValidator(self.fvUpVdt)
        self.lineEdit_setFireVoltageTop.setToolTip('[74, 72]')
        ...
        self.fcDnVdt = VLDR_INTFOLAT(400, 350)
        self.lineEdit_setFireCurrentBottom.setValidator(self.fcDnVdt)
        self.lineEdit_setFireCurrentBottom.setToolTip('[400, 350]')
        # 线路电压
        ...
        # 线路电流
        self.lcUpVdt = VLDR_INTFOLAT(60, 50)
        self.lineEdit_setLineCurrentTop.setValidator(self.lcUpVdt)
        self.lineEdit_setLineCurrentTop.setToolTip('[60, 50]')
        self.lcDnVdt = VLDR_INTFOLAT(5, 0)
        self.lineEdit_setLineCurrentBottom.setValidator(self.lcDnVdt)
        self.lineEdit_setLineCurrentBottom.setToolTip('[5, 0]')
        # 通信电压
        self.cvUpVdt = VLDR_INTFOLAT(38, 36)
        self.lineEdit_setComVoltageTop.setValidator(self.cvUpVdt)
        self.lineEdit_setComVoltageTop.setToolTip('[38, 36]')
        ...
        # 通信电流
        self.ccUpVdt = VLDR_INTFOLAT(12, 8)
        self.lineEdit_setComCurrentTop.setValidator(self.ccUpVdt)
        self.lineEdit_setComCurrentTop.setToolTip('[12, 8]')
        self.ccDnVdt = VLDR_INTFOLAT(5, 0)
        self.lineEdit_setComCurrentBottom.setValidator(self.ccDnVdt)
        self.lineEdit_setComCurrentBottom.setToolTip('[0]')
